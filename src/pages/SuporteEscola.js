...
const SuporteEscola = () => {
  ...
  return (
    <div className="suporte-page">
      <button className="suporte-back-button" onClick={() => navigate(`/escola/${escolaId}`)}>
        ← Voltar
      </button>

      <div className="suporte-header">
        <h1>🆘 Suporte</h1>
        <p>{escola ? `Tickets de suporte - ${escola.name}` : 'Gerencie solicitações de suporte e ajuda'}</p>
      </div>
